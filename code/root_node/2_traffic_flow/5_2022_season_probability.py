...
# 文件夹路径
folder_path = './2022_data'

# 自定义阈值
# low_threshold_customize = 3500
# high_threshold_customize = 10000

two_borough_df = pd.read_excel('./matched_data/2022_sorted_stations.xlsx')
...
print('low threshold',low_threshold_borough)
print('high threshold',high_threshold_borough)
